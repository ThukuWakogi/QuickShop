...
public class CartActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    com.example.elvina.quickshop.CartAdapter cartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.elvina.quickshop.R.layout.cart);

        // Set the RecyclerView to its corresponding view
        mRecyclerView = (RecyclerView) findViewById(com.example.elvina.quickshop.R.id.cart_recycler);
        ...
        paymentButton = (Button) findViewById(com.example.elvina.quickshop.R.id.button_payment);
        //Paypal Intent
    ...
    public double calculateTotal(Cursor cursor){
        ...
        TextView totalCost = (TextView) findViewById(com.example.elvina.quickshop.R.id.totalPrice);
